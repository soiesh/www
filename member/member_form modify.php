...
<?
    ...
    $email1 = $email[0];      // email id
    $email2 = $email[1];     // email account
     ...
     <table>
      <caption class="hidden">회원가입</caption>
     	<tr>
     		...
     		<td>
                <?= $row[id] ?>
     			 ...
     			 <!-- <input type="text" name="id" id="id" placeholder="ID (8자 이내로 입력)" required>
     	...
     	<tr>
     		...
     		<td>
     			 <input type="text" name="nick" id="nick"   placeholder="" value="<?= $row[nick] ?>" required>
     	...
     	<tr>
     		<td colspan="2">
     			<a href="#"><img src="images/check.png"  onclick="check_input()"></a>&nbsp;&nbsp;
				 <a href="#"><img src="images/remove.png" onclick="reset_form()"></a>
     		</td>
     	</tr>
     </table>
